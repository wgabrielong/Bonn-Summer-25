\section{Lecture 8 -- 17th June 2025}\label{sec: lecture 5}
We start with a 
\begin{remark}
...
Herein, we let $K$ be a field with non-Archimedean absolute value (not necessarily complete). Let $f,g\col V\to W$ be linear maps between normed
