...
\begin{proposition}\label{prop: maximum norm is complete}
    Let $A$ be an affinoid $K$-algebra. The norm on $A/\mathrm{Nil}(A)$ by $\Vert\cdot|A\Vert_{\max}$ is equivalent the residual norm. In particular, it is complete. 
\end{proposition}
\begin{proof}
