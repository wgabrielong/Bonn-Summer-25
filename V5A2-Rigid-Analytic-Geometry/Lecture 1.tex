...
\begin{proof}[Proof of (i)]
    ...
    \end{itemize}
    Note that $B/\mfrak^{n}$ is initial amongst affinoid $B$-algebras $C$ such that $\mfrak^{n}C=0$, while $A/\mfrak^{n}$ is initial amongst affinoid $A$-algebras $C'$ such that $\mfrak^{n}C=0$. For $C$ as above, the image of $\Sp(C)$ in $\Sp(B)$ is $\mfrak$, while the image of $\Sp(C')$ in $\Sp(A)$ is $\widetilde{\mfrak}\in\Omega$. Applying the universal property twice, $C'$ can be endowed uniquely with the structure of a $B$-algebra, and by $\kappa(\mfrak)\cong\kappa(\widetilde{\mfrak})$ it follows that $C'$ is annihilated by $\widetilde{\mfrak}$ Thus both $A/\widetilde{\mfrak}^{n}, B/\mfrak^{n}$ satisfy the same universal property, hence isomorphic. 
