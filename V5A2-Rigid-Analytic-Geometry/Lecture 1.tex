...
where $Ω=\Ocal_{\Sp(A)}(A\left\langle\frac{\varepsilon}{f_{0}}\right\rangle\left\langle\frac{f_{1}}{f_{0}},\dots,\frac{f_{n}}{f_{0}}\right\rangle$.
\end{definition}
...
$\tilde{C}$ can be endowed uniquely with the structure of a $B$-algebra, and by $\kappa(\mfrak)\cong\kappa(\widetilde{\mfrak})$ it follows that $\tidle{C}$ is annihilated by $\widetilde{\mfrak}$. Thus both $A/\widetilde{\mfrak}^{n}, B/\mfrak^{n}$ satisfy the same universal property, hence are isomorphic. 
