...
\end{conjecture}
\begin{remark}
    Note that the symmetric monoidal structure on the category of smooth algebras in \Cref{conj: Wagner primes up to dimension inverted} above is not the na\"{i}ve one -- one has to invert the factorial of the dimension of $R\otimes_{\ZZ}R'$ for $R,R'$ in this category. 
\end{remark}
...
\end{definition}
This extends the relationship between prismatic cohomology and topological Hochschild homology. In particular Devalapukar and Raksit has observed that relative to $\KU$ these $q$-deformations appear naturally. 
\begin{conjecture}
