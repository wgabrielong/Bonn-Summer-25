...
\begin{document}
\large
\title[$D$-Modules via Derived Algebraic Stacks -- Bonn, Summer 2025]{V5A2 -- $D$-Modules via Derived Algebraic Stacks \\ Summer Semester 2025}
...
These notes roughly correspond to the course \textbf{V5A2 - $D$-Modules via Derived Algebraic Stacks} taught by Dr. Juan Esteban Rodr\'{i}guez Carmago at the Universit\"{a}t Bonn in the Summer 2025 semester. These notes are \LaTeX-ed after the fact with significant alteration and are subject to misinterpretation and mistranscription. Use with caution. Any errors are undoubtedly my own and any virtues that could be ascribed to these notes ought be attributed to the instructor and not the typist. 
\newpage
\tableofcontents
\appendix
\newpage
